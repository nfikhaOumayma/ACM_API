...
/**
 * This class @{link IncentiveRepaymentRunController} used to control all the Incentive requests.
 *
 * @author HaythemBenizid
 * @since 1.0.8
 */
@RestController
@RequestMapping("/incentive-run-repayment")
public class IncentiveRepaymentRunController {
	...
	public String runIncentiveCalculate() {
		...
		incentiveRepaymentRunService.runIncentiveCalculate();
	...
	public byte[] generateIncentiveReport(@RequestBody IncentiveHistoryDTO incentiveHistoryDTO) {
		...
		return incentiveRepaymentRunService.generateIncentiveReport(incentiveHistoryDTO.getYear(),
	...
	public List<AcmStatutsDTO> getRunYear() {
		...
		List<Integer> years = incentiveRepaymentRunService.getRunYear();
	...
	public List<AcmStatutsDTO> getRunMonth() {
		...
		List<Integer> months = incentiveRepaymentRunService.getRunMonth();
		List<AcmStatutsDTO> acmStatutsDTOs = new ArrayList<>();
		int key = 1;
