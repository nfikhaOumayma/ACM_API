...
/**
 * {@link ClosedAccountDetail} class.
 *
 * @author HaythemBenizid
 * @since 1.0.6.1
 */
public class ClosedAccountDetail {
	...
	/**
	 * Instantiates a new closed account detail.
	 */
	public ClosedAccountDetail() {
