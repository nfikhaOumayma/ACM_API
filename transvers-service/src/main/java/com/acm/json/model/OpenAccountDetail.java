...
/**
 * {@link OpenAccountDetail} class.
 *
 * @author HaythemBenizid
 * @since 1.0.6.1
 */
public class OpenAccountDetail {
	...
	public List<DishonorCheque> dishonorCheque;

	/** The dispute ref. */
	@JsonProperty("DisputeRef")
	public List<DisputeRef> disputeRef;
	...
	/**
	 * Instantiates a new open account detail.
	 */
