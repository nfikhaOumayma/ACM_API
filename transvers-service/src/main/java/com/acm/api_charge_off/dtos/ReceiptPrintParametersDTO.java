...
/**
 * The Class ReceiptPrintParametersDTO.
 */
public class ReceiptPrintParametersDTO extends GenericDTO {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = -1295829573594350768L;
