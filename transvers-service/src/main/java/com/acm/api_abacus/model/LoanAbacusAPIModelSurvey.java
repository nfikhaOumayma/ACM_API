...
/**
 * {@link LoanAbacusAPIModelSurvey} class.
 *
 * @author HaythemBenizid
 * @since 1.0.5
 */
public class LoanAbacusAPIModelSurvey implements Serializable {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 5175865993799018925L;
	...
	/** The udf links. */
	private List<LoanAbacusAPIModelUdfLink> udfLinks;

	/** The udf table. */
	private int udfTable;

	/**
	 * Instantiates a new loan abacus API model survey.
	 */
	public LoanAbacusAPIModelSurvey() {
	 ...
	 * @return the udfLinks
	 */
	public List<LoanAbacusAPIModelUdfLink> getUdfLinks() {
	 ...
	 */
	public void setUdfLinks(List<LoanAbacusAPIModelUdfLink> udfLinks) {
	...
	public String toString() {
		...
		return "LoanAbacusAPIModelSurvey [surveyID=" + surveyID + ", userDefinedFieldGroupID="
