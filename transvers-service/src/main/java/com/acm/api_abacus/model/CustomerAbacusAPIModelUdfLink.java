...
/**
 * {@link CustomerAbacusAPIModelUdfLink} class.
 *
 * @author HaythemBenizid
 * @since 1.0.5
 */
public class CustomerAbacusAPIModelUdfLink implements Serializable {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = -777476645241288095L;
	...
	public String toString() {
		...
		return "CustomerAbacusAPIModelUdfLink [udfLinkID=" + udfLinkID + ", surveyID=" + surveyID
