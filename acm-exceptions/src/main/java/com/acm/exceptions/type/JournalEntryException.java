 ...
 * @since 1.0.10
 */
public class JournalEntryException extends CustomException {
	 ...
	 * @param message the message
	 */
	public JournalEntryException(String exception, String message) {
	 ...
	 */
	public JournalEntryException(ExceptionResponseMessage exceptionResponseMessage) {
	 ...
	 * @param message the message
	 */
	public JournalEntryException(String exception,
