...
/**
 * {@link CollateralNotFoundException} class.
 *
 * @author MoezMhiri
 * @since 0.9.0
 */
public class CollateralNotFoundException extends Exception {
	 ...
	 */
	private static final long serialVersionUID = -8159204923136082851L;
	/** The message. */
	 ...
	 * @param message the message
	 */
	public CollateralNotFoundException(String exception, String message) {
