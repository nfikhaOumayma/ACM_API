...
/**
 * {@link ReportingListDTO} class.
 *
 * @author HaythemBenizid
 * @since 1.1.1
 */
public class ReportingListDTO implements Serializable {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 490347877329186576L;

	/** The reporting list group by DT os. */
	private List<ReportingListGroupByDTO> reportingListGroupByDTOs;
	...
	/**
	 * Instantiates a new reporting list DTO.
	 */
	public ReportingListDTO() {
	...
	/**
	 * Gets the reporting list group by DT os.
	 *
	 * @return the reportingListGroupByDTOs
	 */
	public List<ReportingListGroupByDTO> getReportingListGroupByDTOs() {

		return reportingListGroupByDTOs;
	}

	/**
	 * Sets the reporting list group by DT os.
	 *
	 * @param reportingListGroupByDTOs the reportingListGroupByDTOs to set
	 */
	public void setReportingListGroupByDTOs(
			List<ReportingListGroupByDTO> reportingListGroupByDTOs) {

		this.reportingListGroupByDTOs = reportingListGroupByDTOs;
	}
