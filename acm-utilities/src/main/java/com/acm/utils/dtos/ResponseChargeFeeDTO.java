 ...
 */
public class ResponseChargeFeeDTO extends GenericDTO {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = -3219899914150941715L;

	/** The principal. */
	@JsonProperty("principal")
	public ChargeFeePrincipalDTO principal;

	/** The interest. */
	@JsonProperty("interest")
	public ChargeFeeInterestDTO interest;
	...
	private List<ChargeFeeAcountDTO> accounts;

	/** The fees. */
	@JsonProperty("fees")
	private List<ChargeFeeDTO> fees;
	...
	/** The totals. */
	@JsonProperty("totals")
	private ChargeFeeTotalDTO totals;

	/** The receipt print parameters. */
	@JsonProperty("receiptPrintParameters")
	private ChargeFeeReciptsDTO receiptPrintParameters;
	 ...
	 */
	public ChargeFeePrincipalDTO getPrincipal() {
	 ...
	 */
	public void setPrincipal(ChargeFeePrincipalDTO principal) {
	 ...
	 * @return the interest
	 */
	public ChargeFeeInterestDTO getInterest() {
	 ...
	 */
	public void setInterest(ChargeFeeInterestDTO interest) {
	 ...
	 * @return the accounts
	 */
	public List<ChargeFeeAcountDTO> getAccounts() {
	 ...
	 */
	public void setAccounts(List<ChargeFeeAcountDTO> accounts) {
	 ...
	 * @return the fees
	 */
	public List<ChargeFeeDTO> getFees() {
	 ...
	 */
	public void setFees(List<ChargeFeeDTO> fees) {
	...
	/**
	 * Sets the checks if is arrears.
	 *
	 * @param isArrears the new checks if is arrears
	 */
	 ...
	 * @return the totals
	 */
	public ChargeFeeTotalDTO getTotals() {
	 ...
	 */
	public void setTotals(ChargeFeeTotalDTO totals) {
	 ...
	 */
	public ChargeFeeReciptsDTO getReceiptPrintParameters() {
	 ...
	 */
	public void setReceiptPrintParameters(ChargeFeeReciptsDTO receiptPrintParameters) {
