...
/**
 * {@link AcmDamagedDataDTO} class.
 *
 * @author idridi
 * @since 1.0.8
 */
public class AcmDamagedDataDTO extends GenericDTO implements Serializable {
	 ...
	 */
	public AcmDamagedDataDTO() {

	}

	/**
	 * Instantiates a new acm damaged data DTO.
	 *
	 ...
	 */
	public AcmDamagedDataDTO(String damagedData, String exceptionDetails, Long idAccountExtern) {
	 ...
	 * @param exceptionDetails the exception details
	 */
	public AcmDamagedDataDTO(Long idCustomerExterne, String damagedData, String exceptionDetails) {
