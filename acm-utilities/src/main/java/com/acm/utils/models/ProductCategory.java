...
/**
 * {@link ProductCategory} class.
 *
 * @author HaythemBenizid
 * @since 1.0.8
 */
@Entity
@Table(name = "ACM_PRODUCT_CATEGORY")
@EntityListeners(AuditTrailListener.class)
public class ProductCategory extends GenericModel implements Serializable {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 9041982899526456909L;

	/** The id. */
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "ID_ACM_PRODUCT_CATEGORY", unique = true, nullable = false)
	private Long id;
	...
	@Column(name = "PRODUCT_ID_LIST", nullable = false)
	private String productIdsList;

	/** The incentive repayment. */
	@Column(name = "INCENTIVE_REPAYMENT", nullable = false)
	private Boolean incentiveRepayment;

	/** The incentive registration. */
	@Column(name = "INCENTIVE_REGESTRATION", nullable = false)
	private Boolean incentiveRegistration;

	/** The incentive operation. */
	@Column(name = "INCENTIVE_OPERATION", nullable = false)
	private Boolean incentiveOperation;

	/** The incentive legal. */
	@Column(name = "INCENTIVE_LEGAL", nullable = false)
