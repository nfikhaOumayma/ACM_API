...
/**
 * {@link AcmDamagedCustomer} class.
 *
 * @author idridi
 * @since 1.0.8
 */
@Entity
@Table(name = "ACM_DAMAGED_CUSTOMER")
public class AcmDamagedCustomer extends GenericModel implements Serializable {
	...
	@Column(name = "ID_ACM_DAMAGED_CUSTOMER", unique = true, nullable = false)
	private Long id;
	 ...
	 */
	public AcmDamagedCustomer(Long id, Long idCustomerExterne, String damagedData,
